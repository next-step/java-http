...
class HttpCookieTest {
    ...
    @DisplayName("HttpCookie 객체에서 JSESSIONID를 추가하는 테스트")
    @Test
    void addJSessionIdTest() {
        // given
        final String line = "yummy_cookie=choco; tasty_cookie=strawberry";
        final HttpCookie httpCookie = HttpCookie.fromStringLine(line);

        // when
        httpCookie.addJSessionId("656cef62-e3c4-40bc-a8df-94732920ed46");
