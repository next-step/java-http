...
import org.apache.coyote.http11.handler.StaticRequestHandler;
...
public class RequestMapping {
    ...
    public RequestMapping() {
        ...
        handlers.put(STATIC_PATH, new StaticRequestHandler());
    }

    public Response handleMapping(Request request) throws IOException {
        RequestLine requestLine = request.getRequestLine();
        HttpPath path = requestLine.getPath();
        RequestHandler handler = handlers.getOrDefault(path.getPath(), handlers.get(STATIC_PATH));
