...
public class Connector implements Runnable {
    ...
    public Connector(final int port, final int acceptCount, final CoyoteAdapter adapter) {
        this(port, acceptCount, adapter, DEFAULT_MAX_THREADS);
    }

    public Connector(final int port, final int acceptCount, final CoyoteAdapter adapter, final int maxThreads) {
