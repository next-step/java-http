 ...
 * 배운 부분들
 * 1. java application 내 리소스를 가져오는 법
 * 2. 파일 내용을 FILE, FILES 를 사용해서 가져오는 법
 *  - FILES 는 (BufferedReader reader = newBufferedReader(path, cs)) 에서 버퍼 리더를 사용하는것을 확인
 *  - 해당 버퍼는 IOSTREAM 테스트에서 배운다.
 */
