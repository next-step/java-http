...
class IOStreamTest {
    ...
    class InputStream_학습_테스트 {
        ...
        void InputStream은_데이터를_바이트로_읽는다() throws IOException {
            ...
            try (final BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));
                ...
                actual = lines.collect(Collectors.joining(System.lineSeparator()));
            }
    ...
    class FilterStream_학습_테스트 {
        ...
        void 필터인_BufferedInputStream를_사용해보자() throws IOException {
            ...
            try (final InputStream inputStream = new ByteArrayInputStream(text.getBytes());
                 final InputStream bufferedInputStream = new DataInputStream(inputStream)) {
    ...
    class InputStreamReader_학습_테스트 {
        ...
        void BufferedReader를_사용하여_문자열을_읽어온다() throws IOException {
            ...
            try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream))) {
                writeInputStream(bufferedReader, builder);
            }

            assertThat(builder).hasToString(emoji);
        }

        /**
         * 마지막 EOF 처리를 위해 read() 와 char 로 처리
         */
